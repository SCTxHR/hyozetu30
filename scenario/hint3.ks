[_tb_system_call storage=system/_hint3.ks]
...
[jump  storage="hint3.ks"  target="*2"  cond="sf.hint3=='true'"  ]
*buy

[tb_start_tyrano_code]
[image layer="2" storage="default/hint/buy3.png" name="hint"]
[_tb_end_tyrano_code]
...
[jump  storage="hint3.ks"  target="*buy"  ]
[tb_start_tyrano_code]
[endif]
[_tb_end_tyrano_code]

[tb_eval  exp="sf.hint3='true'"  name="hint3"  cmd="="  op="t"  val="true"  val_2="undefined"  ]
