[_tb_system_call storage=system/_hinta.ks]
...
[jump  storage="hinta.ks"  target="*2"  cond="sf.hinta=='true'"  ]
*buy

[tb_start_tyrano_code]
[image layer="2" storage="default/hint/buya.png" name="hint"]
[_tb_end_tyrano_code]
...
[jump  storage="hinta.ks"  target="*buy"  ]
[tb_start_tyrano_code]
[endif]
[_tb_end_tyrano_code]

[tb_eval  exp="sf.hinta='true'"  name="hinta"  cmd="="  op="t"  val="true"  val_2="undefined"  ]
...
[jump  storage="hinta.ks"  target="*l"  cond="sf.hintk10=='true'"  ]
[wait  time="1000"  ]
