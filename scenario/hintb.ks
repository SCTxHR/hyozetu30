[_tb_system_call storage=system/_hintb.ks]
...
[jump  storage="hintb.ks"  target="*2"  cond="sf.hintb=='true'"  ]
*buy

[tb_start_tyrano_code]
[image layer="2" storage="default/hint/buyb.png" name="hint"]
[_tb_end_tyrano_code]
...
[jump  storage="hintb.ks"  target="*buy"  ]
[tb_start_tyrano_code]
[endif]
[_tb_end_tyrano_code]

[tb_eval  exp="sf.hintb='true'"  name="hintb"  cmd="="  op="t"  val="true"  val_2="undefined"  ]
...
[jump  storage="hintb.ks"  target="*l"  cond="sf.hintk10=='true'"  ]
[wait  time="1000"  ]
